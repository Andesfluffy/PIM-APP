                ...
                >
                  <div className="glass-card p-6 rounded-2xl border border-white/10">
                    ...
                    <p className="text-white/60 text-sm">
                      Create, edit, and organize your thoughts with full-text
                      search
                    </p>
                  </div>
                  ...
                  <div className="glass-card p-6 rounded-2xl border border-white/10">
                    <div className="text-4xl mb-4">✅</div>
                    <h3 className="text-white font-bold text-lg mb-2">Tasks</h3>
                    <p className="text-white/60 text-sm">
              ...
              <div className="text-center">
                ...
                >
                  ...
                  >
                    ...
                    <h3 className="text-white font-bold text-xl mb-2">Notes</h3>
                  ...
                  >
                    ...
                    <h3 className="text-white font-bold text-xl mb-2">Tasks</h3>
            ...
            {!isAuthenticated && view !== "auth" && (
              ...
              >
                ...
                <div className="text-center mb-8">
                  <div className="glass-card p-8 rounded-3xl border border-white/20 mb-6">
                    <h2 className="text-2xl font-bold text-white mb-4">
                      🔒 Preview Mode
                    </h2>
                    <p className="text-white/70 mb-4">
                      Sign in to save and manage your data
                    </p>
                    <LoginButton />
                  </div>
                </div>
