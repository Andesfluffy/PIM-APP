...
const previewShortcuts: {
  key: Exclude<View, "auth" | "dashboard">;
  label: string;
  icon: ReactNode;
}[] = [
  {
      ...
      <AnimatePresence mode="wait">
        {!isAuthenticated && view === "auth" ? (
          <motion.section
            ...
            className="relative flex h-dvh w-full items-center justify-center px-6 py-6 sm:px-10 lg:px-16"
          >
            <div
              className="relative grid h-full w-full max-w-6xl grid-cols-1 items-stretch gap-8 sm:gap-10 lg:grid-cols-[minmax(0,420px)_1fr] lg:gap-14"
            ...
            >
              <motion.div
                ...
                className="relative flex h-full flex-col justify-between gap-6 rounded-[32px] border border-emerald-200/70 bg-white/85 p-7 shadow-[0_42px_70px_-48px_rgba(15,63,42,0.5)] backdrop-blur"
              >
                ...
                <div className="space-y-4">
                  <motion.h1
                    ...
                    className="text-[clamp(2.4rem,4vw,3.2rem)] font-semibold leading-tight text-[#103126]"
                  >
                    Focus in full bloom
                  </motion.h1>
                ...
                <motion.ul
                  ...
                  className="grid gap-3 text-sm text-emerald-700/80"
                >
                  {featureHighlights.map((feature) => (
                    <motion.li
                      key={feature.title}
                      variants={{ hidden: { opacity: 0, y: 10 }, visible: { opacity: 1, y: 0 } }}
                      className="flex items-start gap-3 rounded-3xl border border-emerald-100/60 bg-emerald-50/50 px-4 py-3 shadow-[0_18px_42px_-36px_rgba(18,69,49,0.55)]"
                    >
                ...
                <div className="space-y-3">
                  <LoginButton variant="solid" fullWidth className="text-base">
              ...
              <motion.div
                ...
                className="relative hidden h-full min-h-[420px] overflow-hidden rounded-[36px] border border-emerald-200/60 bg-gradient-to-br from-emerald-600/70 via-emerald-500/60 to-teal-500/60 shadow-[0_58px_90px_-55px_rgba(12,58,40,0.65)] lg:block"
              >
                ...
                <motion.div
                  ...
                  className="absolute left-8 top-8 flex flex-col gap-3"
                >
                  {previewShortcuts.map((shortcut) => (
                    <button
                      key={shortcut.key}
                      type="button"
                      onClick={() => setView(shortcut.key)}
                      className="group flex items-center gap-3 rounded-2xl bg-white/80 px-4 py-2 text-sm font-medium text-emerald-700 shadow-[0_24px_45px_-36px_rgba(16,94,67,0.5)] backdrop-blur transition hover:-translate-y-0.5 hover:bg-white hover:shadow-[0_28px_52px_-34px_rgba(16,94,67,0.55)]"
                    >
                      <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-emerald-50 text-emerald-600 shadow-inner shadow-emerald-100">
                        {shortcut.icon}
                      </span>
                ...
                <motion.div
                  ...
                  className="absolute bottom-10 left-10 right-10 rounded-3xl bg-white/12 p-6 text-white shadow-[0_32px_50px_-36px_rgba(0,0,0,0.5)] backdrop-blur-md"
                >
                ...
                <motion.div
                  ...
                  className="pointer-events-none absolute -bottom-16 left-12 h-48 w-48 rounded-full bg-teal-300/25 blur-3xl"
                />
              </motion.div>
            </div>
          </motion.section>
